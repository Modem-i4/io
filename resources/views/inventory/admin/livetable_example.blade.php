 ...
 function fetch_data()
 {
  $.ajax({
   ...
   success:function(data)
   {
    ...
    html += '<td contenteditable id="parent_id"></td>';
    ...
    for(var count=0; count < data.length; count++)
    {
     ...
     html += '<td contenteditable class="column_name" data-column_name="parent_id" data-id="'+data[count].id+'">'+data[count].parent_id+'</td>';
