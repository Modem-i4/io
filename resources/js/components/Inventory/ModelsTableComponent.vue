                ...
                <v-row>
                    ...
                    >
                        <v-btn
                            ...
                            @click="create"
                        >
                            <svg class="icon icon-plus mx-2"><use xlink:href="/img/icons/symbol-defs.svg#icon-plus"></use></svg><span class="d-none d-md-inline">Створити модель обладнання</span>
                        </v-btn>
                    </v-col>
                </v-row>
        </validation-observer>
